...
public class InterfaceGraficaGerente extends JFrame implements ActionListener {
	...
	public boolean adicionarPrato(){
		...
		for(int i = 0;i<gerente.repositorioR().getNumeroRestaurantes();i++){
			restaurante = gerente.repositorioR().getRestaurante(i);
		...
		int n = JOptionPane.showOptionDialog(null, painel, "Adicionar prato", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE,null,null,null);
		if(n==0){
